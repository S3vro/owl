...
public record x86RShift(Register op1, Register op2, Register target) implements x86Instruction{
    @Override
    public List<x86Instruction> generate() {
        ...
        instructions.add(new x86RShift(target, HardwareRegister.ECX, target));
    ...
    public String toString() {
        return String.format("sar %s, %s%n", op1, op2);
    }
}
